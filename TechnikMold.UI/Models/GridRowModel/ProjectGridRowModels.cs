...
namespace MoldManager.WebUI.Models.GridRowModel
{
    public class ProjectGridRowModels
    {
        ...
        public ProjectGridRowModels(Project Project, IQueryable<ProjectPhase> ProjectPhase, string Flitter, List<Phase> Phases,int attQty)
        {
        ...
        private string BuildCell2(Project Project, string Flitter, int attQty)
        {
            string _cellContent = "";
